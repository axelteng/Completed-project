# Completed-project
  # 485+CAN-delay
    ...
    Receive encoder data via CAN interrupt, store it in a list, compute the angle, generate an RS485 message array with CRC checksum, and transmit the data over RS485.
